...
/* Debug counters for tracing */
volatile uint32 g_soem_bwr_count = 0;
volatile uint32 g_soem_brd_count = 0;
volatile uint32 g_soem_getindex_count = 0;
volatile uint32 g_soem_srconfirm_count = 0;
...
int ecx_BRD(ecx_portt *port, uint16 ADP, uint16 ADO, uint16 length, void *data, int timeout)
{
   ...
   g_soem_brd_count++;  /* Debug counter */
