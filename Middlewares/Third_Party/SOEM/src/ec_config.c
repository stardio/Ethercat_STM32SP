...
/* Debug counters for ec_config */
volatile uint32 g_soem_config_init_entry = 0;
volatile uint32 g_soem_detect_slaves_entry = 0;
volatile uint32 g_soem_init_context_done = 0;
volatile uint32 g_soem_detect_step = 0;  /* Will be set to 50 at runtime */
volatile int g_soem_sockhandle_value = 0;  /* Will be set at runtime */
...
int ecx_config_init(ecx_contextt *context)
{
   ...
   g_soem_config_init_entry++;  /* Debug counter */

   EC_PRINT("ec_config_init\n");
   ecx_init_context(context);
   g_soem_init_context_done++;  /* Debug counter */
